...
namespace ITPC\MySettings\app\Http\Controllers;

use Backpack\CRUD\app\Http\Controllers\CrudController;
// VALIDATION
use ITPC\MySettings\app\Http\Requests\SettingRequest as StoreRequest;
use ITPC\MySettings\app\Http\Requests\SettingRequest as UpdateRequest;
...
class SettingCrudController extends CrudController
{
    public function __construct()
    {
        ...
        $this->crud->setModel("ITPC\MySettings\app\Models\Setting");
        $this->crud->setEntityNameStrings(trans('backpack::settings.setting_singular'), trans('backpack::settings.setting_plural'));
        $this->crud->setRoute(config('backpack.base.route_prefix', 'admin').'/my-setting');
