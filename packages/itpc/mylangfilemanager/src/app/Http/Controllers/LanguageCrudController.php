...
namespace ITPC\MyLangFileManager\app\Http\Controllers;

use Illuminate\Http\Request;
use ITPC\MyLangFileManager\app\Models\Language;
use ITPC\MyLangFileManager\app\Services\LangFiles;
use Backpack\CRUD\app\Http\Controllers\CrudController;
// VALIDATION: change the requests to match your own file names if you need form validation
use ITPC\MyLangFileManager\app\Http\Requests\LanguageRequest as StoreRequest;
use ITPC\MyLangFileManager\app\Http\Requests\LanguageRequest as UpdateRequest;
...
class LanguageCrudController extends CrudController
{
    public function __construct()
    {
        ...
        $this->crud->setModel("ITPC\MyLangFileManager\app\Models\Language");
        $this->crud->setRoute(config('backpack.base.route_prefix', 'admin').'/my-language');
    ...
    public function showTexts(LangFiles $langfile, Language $languages, $lang = '', $file = 'site')
    {
        ...
        if (in_array($file, config('mylangfilemanager.language_ignore'))) {
        ...
        return view('mylangfilemanager::translations', $this->data);
    }
